...
const Navbar = () => {
  return (
    <nav style={{ backgroundColor: "#323351" }}>
      <div className="container mx-auto flex items-center justify-between flex-wrap px-6 pt-6 pb-20 sm:hidden">
      ...
      <div className="container mx-auto md:flex items-center justify-between flex-wrap px-6 pt-6 pb-20 hidden">
        <div className="flex items-center justify-between flex-wrap p-6">
          <Image src={logo} width={160} height={35} alt="Halogenn's logo" className="mr-16" />
          <ul className="flex">
        ...
        <button className={`flex items-center justify-between px-4 py-3 rounded-lg m-6 ${styles.budget}`} style={{ backgroundColor: "rgba(255, 255, 255, 0.09)" }}>
